...
class TransUNet(nn.Module):
    def __init__(self, in_channels, class_num, img_dim, out_channels=128, head_num=4, mlp_dim=256, block_num=8, patch_dim=16):
        super().__init__()
...
class TransUNetGRYTrainer(SegmenTrainer):
    
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.model = TransUNetGRY(*args, **kwargs)#.cuda()
